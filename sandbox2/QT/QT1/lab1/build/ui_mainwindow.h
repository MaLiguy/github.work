...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_openimage->setGeometry(QRect(90, 10, 151, 71));
        ...
        pushButton_openvideo->setGeometry(QRect(90, 90, 151, 71));
        pushButton_openvideo->setFont(font1);
        pushButton_opencamera = new QPushButton(tab);
        pushButton_opencamera->setObjectName(QStringLiteral("pushButton_opencamera"));
        pushButton_opencamera->setGeometry(QRect(90, 170, 151, 71));
        pushButton_opencamera->setFont(font1);
